...
export function ServiceContactModal({ isOpen, onClose }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    // Handle form submission for service contact
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-md w-full p-6 relative">
        ...
        <h2 className="text-2xl font-bold mb-4">Neem contact op voor service</h2>
